...
import (
	...
	handler "github.com/shore-cheng/truss/cmd/_integration-tests/transport/transportpermutations-service/handlers"
	svc "github.com/shore-cheng/truss/cmd/_integration-tests/transport/transportpermutations-service/svc"
)
