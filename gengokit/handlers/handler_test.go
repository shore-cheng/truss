...
import (
	...
	helper "github.com/shore-cheng/truss/gengokit/gentesthelper"
...
func TestApplyServerTempl(t *testing.T) {
	...
	conf := gengokit.Config{
		GoPackage: "github.com/shore-cheng/truss/gengokit/general-service",
	...
	expected := `
		...
		import (
			...
			pb "github.com/shore-cheng/truss/gengokit/general-service"
		)
