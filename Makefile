...
gobindata:
	go generate github.com/shore-cheng/truss/gengokit/template

# Install truss
truss: gobindata
	go install -ldflags '-X "main.version=$(SHA)" -X "main.date=$(VERSION_DATE)"' github.com/shore-cheng/truss/cmd/truss
